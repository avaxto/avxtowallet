import { WalletProvider } from '@/avalanche-wallet-sdk/Wallet/Wallet';
import { UnsafeWallet, WalletNameType } from '@/avalanche-wallet-sdk/Wallet/types';

import { KeyChain as AVMKeyChain, UnsignedTx as AVMUnsignedTx, Tx as AVMTx } from '@/avalanche/apis/avm';
import {
    KeyChain as PlatformKeyChain,
    UnsignedTx as PlatformUnsignedTx,
    Tx as PlatformTx,
} from '@/avalanche/apis/platformvm';
import { pChain, xChain } from '@/avalanche-wallet-sdk/Network/network';
import { Buffer as BufferAvalanche } from '@/avalanche';
import { EvmWallet } from '@/avalanche-wallet-sdk/Wallet/EVM/EvmWallet';
import { UnsignedTx, Tx } from '@/avalanche/apis/evm';
